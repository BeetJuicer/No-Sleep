...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        Color transparent;
        Color32[] cur_colors;
        bool key_was_previously_held_down = false;
...
// 3. Assign this method to the current_brush variable (see how PenBrush does this)
        ...
        private void DrawOnLeftClick()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)
            {
                ...
                else
                {
                    ...
                    if (!key_was_previously_held_down)
                    {
            ...
            key_was_previously_held_down = mouse_held_down;
        }
        ...
        private void DrawOnPlayerWalk()
        {
            ...
            // Mouse is released
            else if (!key_held_down)
            {
                previous_drag_position = Vector2.zero;
                no_drawing_on_current_drag = false;
            }
            key_was_previously_held_down = key_held_down;
        }
